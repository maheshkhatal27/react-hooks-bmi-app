...
const BmiCalculator = () => {
  // const storedHeight = JSON.parse(localStorage.getItem('height')) || 170
  // const storedWeight = JSON.parse(localStorage.getItem('weight')) || 65
  ...
  useEffect(() => {
    ...
    console.log('ht and wt is stored')
  }, [height, weight])
